...
lemlib::MCLSettings::MCLSettings(int particleCount) : particleCount(particleCount) {}
...
lemlib::Chassis::Chassis(Drivetrain drivetrain, ControllerSettings linearSettings, ControllerSettings angularSettings,
                         OdomSensors sensors, MCLSettings mclSettings, DriveCurve* throttleCurve, DriveCurve* steerCurve)
